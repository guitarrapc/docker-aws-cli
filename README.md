...
|AWS CLI                |2.1.27         |AWS commandline tools for managing simple infrastructure tasks                            |
|cUrl                   |7.67.0         |Commandline professional http(s) client tool                                              |
|Bash                   |4.4.19         |Advanced linux shell                                                                      |
|Kubectl                |1.19.6         |Kubectl used to administrate the K8S cluster                                              |
|git                    |2.24.1         |World's most popular version control tool                                                 |
|helm                   |3.5.2          |Package manager for K8S clusters that simplifies complex deployments with simple Charts   |
